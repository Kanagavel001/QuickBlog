  ...
  return (
    <div className='mx-8 sm:mx-16 xl-mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs'>This is your space to think out loud, to shere what matters, and to write without filters. Whether it's one word or a thousand, your story starts right here.</p>
        ...
        <div className='text-center'>
          { 
            input && <button onClick={onClear} className='border font-light text-xs py-1 px-2 rounded-sm shadow-custom-sm cursor-pointer' >
            Clear Search</button>
          }
        </div>
